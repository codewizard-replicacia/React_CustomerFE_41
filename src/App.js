...
import ViewCustomer from "./views/Customer_details/Customer_view";
import CreateCustomerForm from "./views/Customer_details/Customer_createForm";
import EditCustomerForm from "./views/Customer_details/Customer_editForm";
import CustomerTable from "./views/Customer_table/Customer_index";
import "./App.css";
