...
const EditCustomerForm = () => {
  ...
  useEffect(() => {
    const fetchCustomerById = async () => {
      ...
      const jsonResp = await customerResponse.json();
  ...
  const submitForm = async () => {
    ...
    const resp = await makeApiCall(
      `${BASE_URL}${PATH_CUSTOMER}(${formData.CustId})`,
      'PATCH',
            JSON.stringify({
        ...otherData,
    ...
    if (resp.ok) {
      snackbar.enqueueSnackbar('Successfully updated Customer', {
        variant: 'success',
      });
          ...
          <Box display="flex" justifyContent="space-between">
            ...
            <div className="action-buttons">
              ...
              <Button
                ...
                variant="contained"
                color="secondary"
                onClick={() => navigate({ pathname: '/customers' })}
              >
                Cancel
              </Button>
            </div>
